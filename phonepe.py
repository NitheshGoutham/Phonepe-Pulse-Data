...
engine = create_engine("mysql+mysqlconnector://root:Nith_1104@localhost/phonepe") 
...
if selected == "ABOUT":
        ...
        st.markdown('''<h5>Hello! I'm Nithesh Goutham, a BE graduate with a keen interest in data science and analytics.
